...
echo "##############################################"
echo " OcakSonduren , LUTFEN TESEKKUR ETMEYI UNUTMAYIN"
echo "##############################################"
...
echo "###############################################"
echo "###############################"
echo "OcakSonduren TURKHACKTEAM"
echo "###############################"
echo "####################################"
echo " Simdi bu komutla metaspolit'i başlatabilirisin :=>  ./msfconsole"
echo "####################################"
exec bash
